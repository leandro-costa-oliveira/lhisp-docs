---
title: Movimentações Financeiras por Usuário
published: true
editor: markdown
description: ''
---
...
Auditar movimentações financeiras por usuário do sistema.

## Quando usar

Use esta tela quando for necessário consultar o relatório **Movimentações Financeiras por Usuário** no demo do LHISP.

## Pré-requisitos

- Estar autenticado no LHISP.
- Ter acesso ao menu **Relatórios > Movimentações Financeiras por Usuário**.
- Ter permissão para consultar relatórios.

## Passo a passo

1. Acesse **Relatórios > Movimentações Financeiras por Usuário**.
