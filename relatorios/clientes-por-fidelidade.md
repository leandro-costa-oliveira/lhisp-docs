...
Listar clientes por nível de fidelidade.

## Quando usar

Use esta tela quando for necessário consultar o relatório **Clientes por Fidelidade** no demo do LHISP.

## Pré-requisitos

- Estar autenticado no LHISP.
- Ter acesso ao menu **Relatórios > Clientes por Fidelidade**.
- Ter permissão para consultar relatórios.

## Passo a passo

1. Acesse **Relatórios > Clientes por Fidelidade**.
