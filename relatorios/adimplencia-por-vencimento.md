---
title: Adimplência por vencimento
published: true
editor: markdown
description: ''
---
...
Analisar a adimplência por vencimento no recorte selecionado.

## Quando usar

Use esta tela quando for necessário consultar o relatório **Adimplência por vencimento** no demo do LHISP.

## Pré-requisitos

- Estar autenticado no LHISP.
- Ter acesso ao menu **Relatórios > Adimplência por vencimento**.
- Ter permissão para consultar relatórios.

## Passo a passo

1. Acesse **Relatórios > Adimplência por vencimento**.
