---
title: Relatório de Consultas Spc Brasil
published: true
editor: markdown
description: ''
---
...
Consultar as pesquisas realizadas no SPC Brasil.

## Quando usar

Use esta tela quando for necessário consultar o relatório **Relatório de Consultas Spc Brasil** no demo do LHISP.

## Pré-requisitos

- Estar autenticado no LHISP.
- Ter acesso ao menu **Relatórios > Relatório de Consultas Spc Brasil**.
- Ter permissão para consultar relatórios.

## Passo a passo

1. Acesse **Relatórios > Relatório de Consultas Spc Brasil**.
