---
title: Upgrades / Downgrades de Plano
published: true
editor: markdown
description: ''
---
...
Revisar as trocas de plano entre upgrades e downgrades.

## Quando usar

Use esta tela quando for necessário consultar o relatório **Upgrades / Downgrades de Plano** no demo do LHISP.

## Pré-requisitos

- Estar autenticado no LHISP.
- Ter acesso ao menu **Relatórios > Upgrades / Downgrades de Plano**.
- Ter permissão para consultar relatórios.

## Passo a passo

1. Acesse **Relatórios > Upgrades / Downgrades de Plano**.
