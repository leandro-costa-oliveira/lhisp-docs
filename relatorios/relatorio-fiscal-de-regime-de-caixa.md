---
title: Relatório Fiscal de Regime de Caixa
published: true
editor: markdown
description: ''
---
...
Consultar dados fiscais no regime de caixa.

## Quando usar

Use esta tela quando for necessário consultar o relatório **Relatório Fiscal de Regime de Caixa** no demo do LHISP.

## Pré-requisitos

- Estar autenticado no LHISP.
- Ter acesso ao menu **Relatórios > Relatório Fiscal de Regime de Caixa**.
- Ter permissão para consultar relatórios.

## Passo a passo

1. Acesse **Relatórios > Relatório Fiscal de Regime de Caixa**.
