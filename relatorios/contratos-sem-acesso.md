...
Identificar contratos sem acesso configurado.

## Quando usar

Use esta tela quando for necessário consultar o relatório **Contratos Sem Acesso** no demo do LHISP.

## Pré-requisitos

- Estar autenticado no LHISP.
- Ter acesso ao menu **Relatórios > Contratos Sem Acesso**.
- Ter permissão para consultar relatórios.

## Passo a passo

1. Acesse **Relatórios > Contratos Sem Acesso**.
