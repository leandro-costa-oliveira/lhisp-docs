---
title: Projeções e Recebimentos
published: true
editor: markdown
description: ''
---
...
Analisar projeções e recebimentos previstos no período.

## Quando usar

Use esta tela quando for necessário consultar o relatório **Projeções e Recebimentos** no demo do LHISP.

## Pré-requisitos

- Estar autenticado no LHISP.
- Ter acesso ao menu **Relatórios > Projeções e Recebimentos**.
- Ter permissão para consultar relatórios.

## Passo a passo

1. Acesse **Relatórios > Projeções e Recebimentos**.
