---
title: Contratos Sem Mensalidade
published: true
editor: markdown
description: ''
---
...
Localizar contratos sem mensalidade associada.

## Quando usar

Use esta tela quando for necessário consultar o relatório **Contratos Sem Mensalidade** no demo do LHISP.

## Pré-requisitos

- Estar autenticado no LHISP.
- Ter acesso ao menu **Relatórios > Contratos Sem Mensalidade**.
- Ter permissão para consultar relatórios.

## Passo a passo

1. Acesse **Relatórios > Contratos Sem Mensalidade**.
