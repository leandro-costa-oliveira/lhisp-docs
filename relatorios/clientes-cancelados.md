...
Acompanhar o histórico de clientes cancelados no período selecionado.

## Quando usar

Use esta tela quando for necessário consultar o relatório **Clientes Cancelados** no demo do LHISP.

## Pré-requisitos

- Estar autenticado no LHISP.
- Ter acesso ao menu **Relatórios > Clientes Cancelados**.
- Ter permissão para consultar relatórios.

## Passo a passo

1. Acesse **Relatórios > Clientes Cancelados**.
