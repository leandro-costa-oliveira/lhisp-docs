...
>
> Esta página foi migrada a partir da wiki do LHISP. Não foi localizada uma tela equivalente limpa no demo para captura de screenshot, então a documentação foi baseada no conteúdo da wiki.

## Objetivo

Documentar a página principal do módulo **Contratos** no LHISP.
...
- A wiki descreve esta página como a “principal” do sistema.
- Esta tela funciona como ponto de entrada para a maior parte das rotinas diárias do provedor.
- Não foi localizada uma captura limpa do demo para esta página.

## Dúvidas para revisão

- A documentação deve tratar esta página como uma visão geral do módulo ou como uma página operacional?
- Existe uma tela equivalente no demo para captura limpa dessa listagem?
