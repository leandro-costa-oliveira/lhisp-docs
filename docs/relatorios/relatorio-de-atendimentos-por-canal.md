---
title: Relatório de Atendimentos por Canal
---
...
Comparar a distribuição dos atendimentos por canal.

## Quando usar

Use esta tela quando for necessário consultar o relatório **Relatório de Atendimentos por Canal** no demo do LHISP.

## Pré-requisitos

- Estar autenticado no LHISP.
- Ter acesso ao menu **Relatórios > Relatório de Atendimentos por Canal**.
- Ter permissão para consultar relatórios.

## Passo a passo

1. Acesse **Relatórios > Relatório de Atendimentos por Canal**.
