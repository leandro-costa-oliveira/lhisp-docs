---
title: Relatório de Uso de Banda
---
...
Consultar o uso de banda por cliente ou recorte operacional.

## Quando usar

Use esta tela quando for necessário consultar o relatório **Relatório de Uso de Banda** no demo do LHISP.

## Pré-requisitos

- Estar autenticado no LHISP.
- Ter acesso ao menu **Relatórios > Relatório de Uso de Banda**.
- Ter permissão para consultar relatórios.

## Passo a passo

1. Acesse **Relatórios > Relatório de Uso de Banda**.
