...
Acompanhar informações relacionadas ao Registro.BR quando necessário.

## Quando usar

Use esta tela quando for necessário consultar o relatório **Registro.BR** no demo do LHISP.

## Pré-requisitos

- Estar autenticado no LHISP.
- Ter acesso ao menu **Relatórios > Registro.BR**.
- Ter permissão para consultar relatórios.

## Passo a passo

1. Acesse **Relatórios > Registro.BR**.
