---
title: Clientes Negativados - SPC
---
...
Consultar clientes negativados junto ao SPC.

## Quando usar

Use esta tela quando for necessário consultar o relatório **Clientes Negativados - SPC** no demo do LHISP.

## Pré-requisitos

- Estar autenticado no LHISP.
- Ter acesso ao menu **Relatórios > Clientes Negativados - SPC**.
- Ter permissão para consultar relatórios.

## Passo a passo

1. Acesse **Relatórios > Clientes Negativados - SPC**.
