---
title: Lista de Clientes por Plano
---
...
Listar clientes segmentados pelo plano contratado.

## Quando usar

Use esta tela quando for necessário consultar o relatório **Lista de Clientes por Plano** no demo do LHISP.

## Pré-requisitos

- Estar autenticado no LHISP.
- Ter acesso ao menu **Relatórios > Lista de Clientes por Plano**.
- Ter permissão para consultar relatórios.

## Passo a passo

1. Acesse **Relatórios > Lista de Clientes por Plano**.
