---
title: Top N Clientes com mais Ordens de Serviço
---

# Top N Clientes com mais Ordens de Serviço
...
Identificar os clientes com maior volume de ordens de serviço no recorte selecionado.

## Quando usar

Use esta tela quando for necessário consultar o relatório **Top N Clientes com mais Ordens de Serviço** no demo do LHISP.

## Pré-requisitos

- Estar autenticado no LHISP.
- Ter acesso ao menu **Relatórios > Top N Clientes com mais Ordens de Serviço**.
- Ter permissão para consultar relatórios.

## Passo a passo

1. Acesse **Relatórios > Top N Clientes com mais Ordens de Serviço**.
