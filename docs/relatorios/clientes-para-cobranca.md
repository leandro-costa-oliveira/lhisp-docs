...
Revisar os clientes em inadimplência para ações de cobrança.

## Quando usar

Use esta tela quando for necessário consultar o relatório **Clientes para Cobrança** no demo do LHISP.

## Pré-requisitos

- Estar autenticado no LHISP.
- Ter acesso ao menu **Relatórios > Clientes para Cobrança**.
- Ter permissão para consultar relatórios.

## Passo a passo

1. Acesse **Relatórios > Clientes para Cobrança**.
