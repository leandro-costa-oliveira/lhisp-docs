---
title: Top N Clientes com Mais Atendimentos
---

# Top N Clientes com Mais Atendimentos
...
Identificar os clientes com maior volume de atendimentos no recorte selecionado.

## Quando usar

Use esta tela quando for necessário consultar o relatório **Top N Clientes com Mais Atendimentos** no demo do LHISP.

## Pré-requisitos

- Estar autenticado no LHISP.
- Ter acesso ao menu **Relatórios > Top N Clientes com Mais Atendimentos**.
- Ter permissão para consultar relatórios.

## Passo a passo

1. Acesse **Relatórios > Top N Clientes com Mais Atendimentos**.
