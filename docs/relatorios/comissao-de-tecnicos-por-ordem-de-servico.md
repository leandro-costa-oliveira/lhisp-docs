---
title: Comissão de Técnicos por Ordem de Serviço
---
...
Revisar a comissão vinculada às ordens de serviço dos técnicos.

## Quando usar

Use esta tela quando for necessário consultar o relatório **Comissão de Técnicos por Ordem de Serviço** no demo do LHISP.

## Pré-requisitos

- Estar autenticado no LHISP.
- Ter acesso ao menu **Relatórios > Comissão de Técnicos por Ordem de Serviço**.
- Ter permissão para consultar relatórios.

## Passo a passo

1. Acesse **Relatórios > Comissão de Técnicos por Ordem de Serviço**.
