...
Comparar o desempenho de vendas por vendedor.

## Quando usar

Use esta tela quando for necessário consultar o relatório **Vendas por Vendedor** no demo do LHISP.

## Pré-requisitos

- Estar autenticado no LHISP.
- Ter acesso ao menu **Relatórios > Vendas por Vendedor**.
- Ter permissão para consultar relatórios.

## Passo a passo

1. Acesse **Relatórios > Vendas por Vendedor**.
