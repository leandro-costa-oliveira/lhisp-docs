...
Identificar contratos sem serviço associado.

## Quando usar

Use esta tela quando for necessário consultar o relatório **Contratos Sem Serviço** no demo do LHISP.

## Pré-requisitos

- Estar autenticado no LHISP.
- Ter acesso ao menu **Relatórios > Contratos Sem Serviço**.
- Ter permissão para consultar relatórios.

## Passo a passo

1. Acesse **Relatórios > Contratos Sem Serviço**.
